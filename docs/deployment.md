...
2. Select project
3. Click "Deploy" → Choose branch
4. Wait for build (typically 2-5 minutes)
...
Configure all variables in **Vercel Dashboard → Settings → Environment Variables**
...
**Related:** [Development Guide](development.md) | [Environment Setup](development.md#environment-variables)
