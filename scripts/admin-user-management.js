...
if (!command) {
  ...
  console.log('');
  console.log('Usage:');
  console.log('  node scripts/promote-user-to-admin.js list                    # List all users');
  console.log('  node scripts/promote-user-to-admin.js <email> [role]         # Promote user');
  console.log('  node scripts/promote-user-to-admin.js demote <email>         # Demote user');
  console.log('');
  console.log('Available roles:', AVAILABLE_ROLES.join(', '));
  console.log('');
  console.log('Examples:');
  console.log('  node scripts/promote-user-to-admin.js list');
  console.log('  node scripts/promote-user-to-admin.js steve@example.com admin');
  console.log('  node scripts/promote-user-to-admin.js steve@example.com recruiter');
  console.log('  node scripts/promote-user-to-admin.js demote steve@example.com');
  process.exit(1);
}
