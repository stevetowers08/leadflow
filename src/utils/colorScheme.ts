...
export const UNIFIED_COLOR_SCHEME: StatusColorScheme = {
  leadStages: {
    ...
    'NEW LEAD': { background: 'bg-blue-50', text: 'text-blue-700', border: 'border-blue-200' },
    'new': { background: 'bg-blue-50', text: 'text-blue-700', border: 'border-blue-200' },
    'new lead': { background: 'bg-blue-50', text: 'text-blue-700', border: 'border-blue-200' },
    'contacted': { background: 'bg-blue-50', text: 'text-blue-700', border: 'border-blue-200' },
    
    // Active/In Progress - Yellow/Orange (work in progress)
    'IN QUEUE': { background: 'bg-yellow-50', text: 'text-yellow-700', border: 'border-yellow-200' },
    'in queue': { background: 'bg-yellow-50', text: 'text-yellow-700', border: 'border-yellow-200' },
    'CONNECT SENT': { background: 'bg-orange-50', text: 'text-orange-700', border: 'border-orange-200' },
    'connect sent': { background: 'bg-orange-50', text: 'text-orange-700', border: 'border-orange-200' },
    'connection_requested': { background: 'bg-orange-50', text: 'text-orange-700', border: 'border-orange-200' },
    'MSG SENT': { background: 'bg-amber-50', text: 'text-amber-700', border: 'border-amber-200' },
    'msg sent': { background: 'bg-amber-50', text: 'text-amber-700', border: 'border-amber-200' },
    'messaged': { background: 'bg-amber-50', text: 'text-amber-700', border: 'border-amber-200' },
    ...
    'replied': { background: 'bg-emerald-50', text: 'text-emerald-700', border: 'border-emerald-200' },
    'qualified': { background: 'bg-green-50', text: 'text-green-700', border: 'border-green-200' },
  ...
  employmentTypes: {
    'full-time': { background: 'bg-blue-50', text: 'text-blue-700', border: 'border-blue-200' },
    'part-time': { background: 'bg-purple-50', text: 'text-purple-700', border: 'border-purple-200' },
    'contract': { background: 'bg-orange-50', text: 'text-orange-700', border: 'border-orange-200' },
    'internship': { background: 'bg-green-50', text: 'text-green-700', border: 'border-green-200' },
    'freelance': { background: 'bg-yellow-50', text: 'text-yellow-700', border: 'border-yellow-200' },
  },
  ...
  workflowSteps: {
    'trigger': { background: 'bg-blue-50', text: 'text-blue-700', border: 'border-blue-200' },
    'condition': { background: 'bg-yellow-50', text: 'text-yellow-700', border: 'border-yellow-200' },
    'action': { background: 'bg-green-50', text: 'text-green-700', border: 'border-green-200' },
    'delay': { background: 'bg-purple-50', text: 'text-purple-700', border: 'border-purple-200' },
  },
};
...
export function getUnifiedStatusColors(status: string): ColorScheme {
  ...
  // Default fallback
  return { background: 'bg-slate-50', text: 'text-slate-700', border: 'border-slate-200' };
}
