    ...
    >
          ...
          <div className='text-sm text-gray-900 font-medium'>
            {lead.email_address ? (
              <a
                ...
                className='text-sidebar-primary hover:text-sidebar-primary/80 transition-colors truncate'
              >
                {lead.email_address}
              </a>
            ) : (
      ...
      <div className='grid grid-cols-3 gap-3'>
        ...
        <div className='space-y-1'>
          ...
          <div
            className={`h-8 px-3 rounded-md text-xs font-medium border flex items-center justify-center w-fit ${getTextScoreBadgeClasses(lead.lead_score)}`}
          >
            {lead.lead_score || '-'}
          </div>
        </div>
