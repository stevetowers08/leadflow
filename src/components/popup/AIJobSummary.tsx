...
export const AIJobSummary: React.FC<AIJobSummaryProps> = ({
  job,
  className,
}) => {
    ...
    <div className={`space-y-3 ${className}`}>
      ...
      {lastResult && (
        <div className='space-y-3 p-3 bg-primary/10 border border-primary/20 rounded-lg'>
          ...
          {/* Key Requirements */}
          {lastResult.key_requirements &&
            lastResult.key_requirements.length > 0 && (
              <div>
