  ...
  const runDiagnostics = async () => {
    ...
    try {
      ...
      if (user) {
        try {
          ...
          results.push({
            ...
            details:
              error?.message ||
              (data ? `Role: ${data.role}` : 'No profile data'),
            icon: <User className='h-5 w-5' />,
          });
        } catch (err) {
          results.push({
      ...
      results.push({
        ...
        message: hasJsErrors
          ? 'JavaScript runtime is functional'
          : 'JavaScript runtime issues detected',
        ...
        <div className='bg-white rounded-lg shadow-lg p-6'>
          ...
          <div className='mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg'>
            ...
            <ul className='text-sm text-blue-800 space-y-1'>
              ...
              <li>
                • Contact support if all checks pass but the app still shows a
                white screen
              </li>
            </ul>
          </div>
