    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Monitor assignment system performance and identify optimization opportunities
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{metrics?.assignmentCount || 0}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{metrics?.bulkOperationCount || 0}</div>
            <p className="text-xs text-muted-foreground">
              This month
            </p>
          </CardContent>
            ...
            {performanceRecommendations.map((rec, index) => (
              <div key={index} className="flex items-start gap-3 p-3 border rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm font-medium text-sidebar-primary">{rec.action}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <CardContent>
          <div className="space-y-2 text-orange-800">
            <div className="flex items-center gap-2">
              ...
              <span>Monitor bulk assignment performance with large datasets</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
              <span>Consider implementing assignment queues for high-volume operations</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
              <span>Set up monitoring alerts for assignment failure rates above 5%</span>
            </div>
          </div>
        </CardContent>
      </Card>
