...
export const ActivityTimeline = ({ leadId, leadName }: ActivityTimelineProps) => {
    ...
    try {
      ...
      if (lead["LinkedIn Connected"] && lead["Connection Accepted Date"]) {
        timelineActivities.push({
          ...
          description: lead["LinkedIn Connected Message"] || "Follow-up message sent on LinkedIn",
          date: lead["Connection Accepted Date"],
          icon: MessageCircle,
      ...
      if (lead["Meeting Date"]) {
        timelineActivities.push({
          ...
          type: "meeting_booked",
          title: lead["Meeting Booked"] === "Yes" ? "Meeting Scheduled" : "Meeting Planned",
