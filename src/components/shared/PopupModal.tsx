              ...
              <div className='flex-1 min-w-0'>
                ...
                {subtitle && (
                  <p
                    ...
                    className='text-xs font-medium text-gray-400 leading-tight truncate'
                  >
                    {isLoading ? (
                    ...
                    canChangeStage
                      ? () => {
                          ...
                          const stageMap = {
                            ...
                            meeting_scheduled:
                              getStatusDisplayText('meeting_scheduled'),
                            proposal_sent:
                              getStatusDisplayText('proposal_sent'),
                          ...
                          if (
                            window.confirm(
                              `Move from "${stageMap[currentStage]}" to "${stageMap[nextStage]}"?`
                            )
                          ) {
