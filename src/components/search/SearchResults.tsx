            ...
            <div className="flex items-center gap-4 text-xs text-gray-500">
              ...
              {result.type === 'person' && result.metadata?.email && (
                <div className="flex items-center gap-1">
                  ...
                  <span className="truncate max-w-32">{result.metadata.email}</span>
                </div>
              )}
              ...
              {result.metadata?.employeeLocation && (
                <div className="flex items-center gap-1">
                  ...
                  <span className="truncate max-w-24">{result.metadata.employeeLocation}</span>
                </div>
              )}
              ...
              {result.metadata?.priority && (
                <Badge 
                  ...
                  className={cn(
                    "text-xs",
                    result.metadata.priority === 'high' || result.metadata.priority === 'urgent' 
