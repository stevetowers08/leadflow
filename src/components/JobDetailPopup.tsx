                  ...
                  <div className="pb-4">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-12 h-12 rounded-xl flex items-center justify-center overflow-hidden">
                        {(() => {
                          const logoUrl = job.companies.profile_image_url || getClearbitLogo(job.companies.name, job.companies.website);
                          return logoUrl ? (
                            <img 
                              src={logoUrl} 
                        ...
                        <div className="w-full h-full bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl flex items-center justify-center" style={{ display: (job.companies.profile_image_url || getClearbitLogo(job.companies.name, job.companies.website)) ? 'none' : 'flex' }}>
