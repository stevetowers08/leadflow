  ...
  "relative overflow-hidden transition-all duration-300 ease-out group",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-to-br from-primary/5 to-secondary/5 border border-primary/15",
      },
      size: {
        sm: "p-4 rounded-lg",
        md: "p-6 rounded-lg",
...
const activityCardVariants = cva(
  "relative overflow-hidden transition-all duration-300 ease-out",
  {
    variants: {
      variant: {
        glass: "bg-white/40 backdrop-blur-sm border border-white/20 hover:bg-white/50",
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div 
                    className={cn(
                      ...
                      metric.color === "primary" && "bg-gradient-to-r from-primary to-primary/80",
                      metric.color === "success" && "bg-gradient-to-r from-success to-success/80",
                      metric.color === "warning" && "bg-gradient-to-r from-warning to-warning/80",
                      metric.color === "info" && "bg-gradient-to-r from-blue-500 to-blue-400",
                      !metric.color && "bg-gradient-to-r from-primary to-secondary"
                    )}
...
export {
    ActivityCard, activityCardVariants, ChartCard, chartCardVariants, MetricCard, metricCardVariants, PerformanceCard, performanceCardVariants, QuickActionsCard, quickActionsCardVariants
};
