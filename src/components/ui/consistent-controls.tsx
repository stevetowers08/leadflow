  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 hover:bg-muted/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        active: "bg-white text-foreground shadow-sm border border-border ring-1 ring-primary/10",
        glass: "bg-white/10 backdrop-blur-sm text-white hover:bg-white/20 border border-white/20",
        neumorphism: "bg-gray-100 text-gray-700 shadow-neumorphism-light hover:shadow-lg",
      },
      size: {
  ...
  ({ className, variant, size, active, ...props }, ref) => {
    return (
      <button
        ...
        ,
          active && "after:content-[''] after:absolute after:left-2 after:right-2 after:-bottom-px after:h-[2px] after:bg-primary"
        )}
        role="tab"
...
export {
    ...
    SearchInput,
    searchVariants,
    Tab, TableCell, TableHeader,
    tableHeaderVariants, TableRow, TabsList,
    tabsVariants
};
