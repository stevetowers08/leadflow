...
export const ConversationViewer: React.FC<ConversationViewerProps> = ({
  ...
  if (!conversation) {
    return (
      <div
        className={cn(
          'h-full flex flex-col bg-gradient-to-b from-background to-muted/20',
          className
        )}
      >
        <div className='flex-1 flex items-center justify-center'>
          <div className='text-center text-muted-foreground'>
            ...
            <p className='text-sm text-muted-foreground max-w-md leading-relaxed'>
              Choose a conversation from the list to view messages, reply to
              leads, and continue your outreach efforts
            </p>
          ...
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <div className='flex items-center gap-3 text-sm text-muted-foreground'>
                ...
                <span>•</span>
                <span>
                  Last active {formatDate(conversation.last_message_at)}
                </span>
              </div>
            </div>
          </div>
