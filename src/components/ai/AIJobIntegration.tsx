...
import { JobSummaryGenerator, BatchJobSummarization, AIStatusIndicator } from '../components/ai/AIComponents';
 ...
 */
export function AIJobIntegration({ jobData, className }: AIJobIntegrationProps) {
        ...
        <CardContent>
          ...
          <div className="mt-4 p-3 bg-blue-50 rounded-lg">
            <div className="text-sm text-blue-800">
              <strong>Free Tier Benefits:</strong> 60 requests per minute, no cost for basic usage, 
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Manage your job postings with AI assistance</p>
      </div>
