...
export function LinkedInConfirmationModal({
  ...
  console.log('🚀 LinkedInConfirmationModal rendered with:', {
    isOpen,
  ...
  console.log(
    '🔍 LinkedInConfirmationModal render - isOpen:',
    isOpen,
    'selectedLeads:',
  ...
  const handleConfirm = async () => {
    console.log(
      '🚀 AUTOMATION DEBUG: LinkedInConfirmationModal handleConfirm called'
    );
    ...
    try {
      ...
      try {
        ...
        console.log(
          `Webhook results: ${successful} successful, ${failed} failed`
        );
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        className='max-w-5xl max-h-[90vh] overflow-hidden relative bg-white'
        style={{ zIndex: 99999 }}
      >
          ...
          <div className='absolute inset-0 bg-green-50/90 backdrop-blur-sm flex items-center justify-center z-50 rounded-lg'>
            <div className='text-center'>
              ...
              <p className='text-sm text-green-600'>
                ...
                {selectedLeads.length !== 1 ? 's' : ''} sent to automation queue
              </p>
            </div>
          </div>
        )}
        ...
        <div className='space-y-3'>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        value={
                          ...
                          "Thank you for connecting! I'd love to learn more about your experience at " +
          ...
          <div className='flex justify-between items-center pt-2 border-t'>
            <div className='text-xs text-gray-500'>
              ...
              {selectedLeads.length} have LinkedIn
            </div>
