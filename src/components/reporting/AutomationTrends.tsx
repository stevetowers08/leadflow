...
const AutomationTrends: React.FC<AutomationTrendsProps> = ({ monthlyStats }) => {
  ...
  const maxValue = Math.max(...processedData.map(d => Math.max(d.people, d.automations, d.responses, d.meetings)));
              ...
              <div key={index} className="flex flex-col items-center gap-2 flex-1">
                <div className="w-full flex flex-col gap-1">
                  ...
                  <div 
                    ...
                    style={{ height: `${(data.automations / maxValue) * 120}px` }}
