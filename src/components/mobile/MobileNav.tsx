        ...
        <div className="flex items-center justify-around px-2 py-3">
          {primaryItems.map((item) => (
            ...
            >
              ...
              <span className="mobile-nav-item leading-none font-medium text-center">{item.label}</span>
            </NavLink>
          ))}
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="mobile-nav-item leading-none font-medium text-center">More</span>
            </Button>
                  ...
                  <div className="py-2">
                    {secondaryItems.map((item) => (
                      ...
                      >
                        ...
                        <span className="mobile-body-sm font-medium">{item.label}</span>
                      </NavLink>
                    ))}
                  </div>
                </div>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 min-w-0 flex-1">
          ...
          <div className="min-w-0 flex-1">
            <div className="mobile-data-number truncate">
              {value}
            </div>
            <div className="mobile-data-label truncate">
              {title}
            </div>
          </div>
        </div>
