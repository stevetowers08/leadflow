...
import { Loader2, Save, Building2, Target, Users, TrendingUp } from 'lucide-react';
...
const BusinessProfileSettings: React.FC = () => {
  ...
  const handleIdealCustomerProfileChange = (field: string, value: string | string[]) => {
    setProfile(prev => ({
      ...prev,
      ideal_customer_profile: {
  ...
  const addArrayItem = (field: 'technologies' | 'pain_points', value: string) => {
  ...
  const removeArrayItem = (field: 'technologies' | 'pain_points', index: number) => {
    setProfile(prev => ({
      ...prev,
      ideal_customer_profile: {
        ...prev.ideal_customer_profile,
        [field]: prev.ideal_customer_profile[field]?.filter((_, i) => i !== index) || []
      }
    }));
  };
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Targeting Profiles</h1>
        <p className="text-gray-600">
          Configure your targeting criteria to improve lead filtering and qualification.
          This data will help the system better match leads to your ideal customer profile.
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your company's basic details and industry information for targeting
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleIdealCustomerProfileChange('company_size', e.target.value)}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleIdealCustomerProfileChange('location', e.target.value)}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleIdealCustomerProfileChange('revenue', e.target.value)}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleIdealCustomerProfileChange('industry', e.target.value)}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-2 mb-2">
                {profile.ideal_customer_profile.technologies?.map((tech, index) => (
                  <span
                    key={index}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-2 mb-2">
                {profile.ideal_customer_profile.pain_points?.map((pain, index) => (
                  <span
                    key={index}
          ...
          <CardContent>
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => setProfile(prev => ({ ...prev, business_goals: e.target.value }))}
