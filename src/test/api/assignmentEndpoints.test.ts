...
describe('Assignment API Endpoint Tests', () => {
  ...
  describe('GET /api/assignments/history/{entityType}/{entityId}', () => {
    it('should return assignment history', async () => {
      ...
      const response = await fetch(`${baseUrl}/assignments/history/people/${testEntityId1}`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${authToken}`,
          'Content-Type': 'application/json'
    ...
    it('should return empty array for entity with no history', async () => {
      const response = await fetch(`${baseUrl}/assignments/history/people/${testEntityId2}`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${authToken}`,
          'Content-Type': 'application/json'
    ...
    it('should return 404 for non-existent entity', async () => {
      const response = await fetch(`${baseUrl}/assignments/history/people/non-existent-id`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${authToken}`,
          'Content-Type': 'application/json'
