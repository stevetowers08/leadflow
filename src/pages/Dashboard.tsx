...
export default function Dashboard() {
  ...
  const handleItemClick = useCallback((item: Job | Company, type: 'job' | 'company' | 'person') => {
    if (type === 'job') {
  ...
  useEffect(() => {
    ...
    const fetchIndividualQueries = async (today: string, todayEnd: string) => {
      ...
      if (jobsResult.error || peopleResult.error || companiesResult.error || interactionsResult.error) {
        ...
        <div className="grid gap-6 grid-cols-1 lg:grid-cols-2">
          ...
          <ModernCard variant="minimal" className="p-4">
            ...
            <div className="space-y-2.5">
              ...
              {todaysJobs.length === 0 && (
                <div className="text-xs text-gray-500">No recent jobs found.</div>
              )}
            </div>
          </ModernCard>
          ...
          <ModernCard variant="minimal" className="p-4">
            ...
            <div className="space-y-2.5">
              ...
              {todaysCompanies.length === 0 && (
                <div className="text-xs text-gray-500">No recent companies found.</div>
              )}
            </div>
          </ModernCard>
        </div>
