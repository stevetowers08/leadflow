        ...
        <div className='space-y-6 w-full px-4 py-6 lg:px-6'>
          <div className='space-y-6'>
                ...
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <p className='text-2xl font-bold text-foreground'>
                      {isLoading
                        ? '-'
                        : (data?.totalPeople ?? 0).toLocaleString()}
                    </p>
                  </div>
                ...
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <p className='text-2xl font-bold text-foreground'>
                      {isLoading
                        ? '-'
                        : (data?.totalCompanies ?? 0).toLocaleString()}
                    </p>
                  </div>
                  <div className='h-8 w-8 flex items-center justify-center'>
              ...
              >
                <LineChart
                  data={(data?.monthlyStats ?? [])
                    .slice(-30)
                    .map(m => ({ label: m.month.slice(5), value: m.people }))}
                  height={280}
                  showGrid={true}
                  showValues={false}
                />
            ...
            <div className='grid gap-8 grid-cols-1 lg:grid-cols-3'>
              ...
              >
                <BarChart
                  data={(data?.interactionsByType ?? []).map(i => ({
                    label: i.type,
                    value: i.count,
                  }))}
                  height={200}
            ...
            <div className='grid gap-8 grid-cols-1 lg:grid-cols-2'>
              ...
              <ActivityCard
                ...
                activities={(data?.recentInteractions ?? [])
                  .slice(0, 8)
                  .map(a => ({
                    id: a.id,
                    icon:
