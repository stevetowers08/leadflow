  ...
  const fetchMorningJobs = async () => {
    try {
      ...
      const { data, error } = await supabase
        .from("Jobs")
        .select("*")
        .gte("Posted Date", twentyFourHoursAgo.toISOString())
        .order("Posted Date", { ascending: false });
      ...
      toast({
        title: "Error",
        description: "Failed to fetch morning jobs",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
    ...
    <>
      <div className="space-y-4">
        <div className="border-b pb-3">
          <h1 className="text-lg font-semibold tracking-tight">Morning View</h1>
