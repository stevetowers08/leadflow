  ...
  const keyFeatures = [
    {
      ...
      description:
        'Automatically score and prioritize leads based on AI analysis',
      benefits: [
            ...
            <div className='space-y-6'>
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                ...
                <div className='space-y-3'>
                  ...
                  <p className='text-sm text-muted-foreground ml-10'>
                    Import or manually add your prospects and watch AI score
                    them automatically.
                  </p>
                </div>
                <div className='space-y-3'>
                  ...
                  <p className='text-sm text-muted-foreground ml-10'>
                    Configure automated outreach sequences and watch your
                    productivity soar.
                  </p>
                </div>
              </div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                <div className='space-y-3'>
                  ...
                  <p className='text-sm text-muted-foreground ml-10'>
                    Set up your sales stages and start moving leads through your
                    process.
                  </p>
                </div>
                <div className='space-y-3'>
                  ...
                  <p className='text-sm text-muted-foreground ml-10'>
                    Monitor your success with real-time analytics and
                ...
                <div className='space-y-3'>
                  ...
                  <p className='text-sm text-muted-foreground ml-10'>
                    Use insights to optimize your process and achieve even
                    better results.
                  </p>
                </div>
              </div>
          ...
          <CardContent>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              <div className='space-y-3'>
                ...
                <p className='text-sm text-muted-foreground'>
                  Our platform is designed to be intuitive and easy to use. If
                  you need assistance, check out our built-in help system or
                  contact support.
                </p>
                <div className='flex gap-2'>
                  <Button
                    ...
                    className='flex-1'
                    onClick={() =>
                      window.open('/docs/MASTER_INDEX.md', '_blank')
                    }
                  >
